---
description: Especificação da regra de descarte de etapas para o CCO
---
# Especificação: Regra de Descarte (CCO)

## O Quê
Reintroduzir a regra de descarte no Campeonato Cearense de Orientação (CCO), permitindo que os atletas descartem o resultado de uma etapa com menor pontuação, sob condições específicas. O descarte deverá ser habilitado exclusivamente para edições do campeonato que tenham mais de 3 (três) etapas realizadas.
